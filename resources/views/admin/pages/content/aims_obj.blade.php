...
$pagename = '<a href="'.$kurl.'"><b>Edit Contents</b></a>  <span style="margin-left: 15px">Aims and Objectives</span>';
$li_active['obj'] = 'li-active';
        ...
        <div class="col-sm-10">
            ...
            <form action="{{route('console.content.save')}}" method="post" class="form-horizontal" role="form" id="wysiwyg">
                ...
                <div class="form-group" >
                    <textarea class="form-control abt_field" name="f_aims_obj" id="" cols="30" rows="10">{{ $content['f_aims_obj'] }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="list-group-item">
                            @if( isset($content['f_aims_obj_img']))
                                <img src="{{ url('uploads/'.$content['f_aims_obj_img']) }}" alt="" class="image_src img-fit">
                            @else
                        ...
                        <input type="text" name="f_aims_obj_img" value="" style="display: none" class="new_event_img ">
                    </div>
                </div>
