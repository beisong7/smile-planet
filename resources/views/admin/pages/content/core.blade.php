...
$pagename = '<a href="'.$kurl.'"><b>Edit Contents</b></a>  <span style="margin-left: 15px">Core Values</span>';
$li_active['corevals'] = 'li-active';
        ...
        <div class="col-sm-10">
            ...
            <form action="{{route('console.content.save')}}" method="post" class="form-horizontal" role="form" id="wysiwyg">
                ...
                <div class="form-group">
                    <textarea class="form-control abt_field" name="corevals" id="" cols="30" rows="10">{{ $content['corevals'] }}</textarea>
                </div>
                <div class="form-group" >
