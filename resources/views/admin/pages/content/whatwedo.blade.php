...
$pagename = '<a href="'.$kurl.'"><b>Edit Contents</b></a>  <span style="margin-left: 15px">What we Do</span>';
$li_active['wwd'] = 'li-active';
        ...
        <div class="col-sm-10">
            ...
            <form action="{{route('console.content.save')}}" method="post" class="form-horizontal" role="form" id="wysiwyg">
                ...
                <div class="form-group" >
                    <textarea class="form-control abt_field" name="f_what_we_do" id="" cols="30" rows="10">{{ $content['f_what_we_do'] }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="list-group-item">
                            @if( isset($content['f_what_we_do_img']))
                                <img src="{{ url('uploads/'.$content['f_what_we_do_img']) }}" alt="" class="image_src img-fit">
                            @else
                        ...
                        <input type="text" name="f_what_we_do_img" value="" style="display: none" class="new_event_img ">
                    </div>
                </div>
